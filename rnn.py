...
def convert_input_to_vectors(data, embed):
	...
	'''
	# initially, we found that about 9% of words are unknown -
	# 	mostly words next to or containing punctuation - so
	#	in preprocessing we remove punctuation
	# (the embeddings change words like "don't" to "dont")
	vectorized_data = [] 
	# tot_count = 0
	# unk_count = 0
